...
void addr_pcr(context *c){ //program counter relative r
  c->ea = c->registers->PC+1 + RAM[c->registers->PC+1];
  c->registers->PC += 2;
}
...
opcode opcodes[] = {
  ...
  {OP_bpl, "bpl", addr_pcr}, {NULL, "ora", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "slo", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "ora", NULL}, {NULL, "asl", NULL}, {NULL, "slo", NULL}, {NULL, "clc", NULL}, {NULL, "ora", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "slo", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "ora", NULL}, {NULL, "asl", NULL}, {NULL, "slo", NULL}, 
  ...
  {OP_bmi, "bmi", addr_pcr}, {NULL, "and", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "rla", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "and", NULL}, {NULL, "rol", NULL}, {NULL, "rla", NULL}, {NULL, "sec", NULL}, {NULL, "and", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "rla", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "and", NULL}, {NULL, "rol", NULL}, {NULL, "rla", NULL}, 
  ...
  {OP_bvs, "bvs", addr_pcr}, {NULL, "adc", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "rra", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "adc", NULL}, {NULL, "ror", NULL}, {NULL, "rra", NULL}, {NULL, "sei", NULL}, {NULL, "adc", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "rra", NULL}, {OP_nop, "nop", addr_implied}, {NULL, "adc", NULL}, {NULL, "ror", NULL}, {NULL, "rra", NULL}, 
